...
var script = {
  ...
  methods: {
    ...
    _getPTValue: function _getPTValue() {
      ...
      var merged = mergeProps(self, globalPT2, _objectSpread(_objectSpread({}, key === "root" && _defineProperty({}, "".concat(datasetPrefix, "name"), ObjectUtils.toFlatCase(this.$.type.name))), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), ObjectUtils.toFlatCase(key))));
      return merged;
    },
    ptm: function ptm() {
...
//# sourceMappingURL=chunk-H55F4SJ2.js.map
